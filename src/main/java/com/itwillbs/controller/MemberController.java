...
public class MemberController {
    ...
    public String step2Pro(HttpServletRequest request, HttpSession session, Model model) {
        ...
        if(userId == null || userId.isEmpty() || password == null || password.isEmpty() ||
           username == null || username.isEmpty() || nickname == null || nickname.isEmpty() ||
           email == null || email.isEmpty() || gender == null || gender.isEmpty() ||
           birthDate == null || birthDate.isEmpty() || phone == null || phone.isEmpty()) {
...
//    ===================================================
 ...
 // 로그인 POST 
    ...
    public String loginPOST(MemberVO memberVO, HttpSession session, Model model, HttpServletRequest request, HttpServletResponse response) {
